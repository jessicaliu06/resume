...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem
            {\textbf{Design \& Analysis of Algorithms} (Fall 2025 -- Present): Teach advanced topics in algorithms (graph algorithms, dynamic programming, complexity theory); host office hours for classes of 600+ students.}
        \resumeItem
            {\textbf{Computer Organization \& Programming} (Spring 2025): Led weekly labs to teach fundamental concepts in computer architecture \& hardware, assembly programming, C programming, and memory management; hosted office hours for 800+ students.}
        \resumeItem
            {\textbf{Object-Oriented Programming} (Spring 2024 -- Fall 2024): Developed original teaching strategies, materials, and exercises for continued use in future semesters by 30+ TAs across 12 recitation sections attended by 800+ students; teach weekly recitations; host 6+ office hours per week.}
      \resumeItemListEnd
